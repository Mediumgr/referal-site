  ...
  <section class="section">
    ...
    >
      <div class="wrapper-dropdown_select">
        ...
        <svg
          :class="['wrapper-dropdown_cross', checked[index] ? 'active' : '']"
...
const data = ref([
  ...
  {
    title:
      'Если у\u00A0меня несколько друзей, могу\u00A0ли я\u00A0получить выплаты за\u00A0всех?',
    text: 'Можете.',
  },
]);
...
const showHiddenText = (index) => {
  ...
  if (hiddenNode.clientHeight) {
    ...
    hiddenNode.style.height = clientHeight + 5 + 'px';
  }
};
</script>
