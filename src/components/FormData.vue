  ...
  <section>
    <div class="form-section">
      ...
      <template class="form-section-flex">
        <transition name="form-fade">
          <form
            v-if="recommender"
            @submit.stop.prevent="stepTwo()"
            class="form_recommender"
          >
            <div class="form firstForm">
              ...
              <BaseInput
                ...
                type="text"
                :error="regExpChecks['recommenderName']"
                label="text"
                text="Имя и&nbsp;фамилия"
              >
              </BaseInput>
              <BaseInput
                ...
                type="email"
                :error="regExpChecks['recommenderEmail']"
                label="email"
                text="Email"
              >
              </BaseInput>
              <BaseInput
                ...
                type="tel"
                :error="regExpChecks['recommenderPhone']"
                label="tel"
                text="Номер телефона"
              >
              </BaseInput>
              <BaseCheckbox
                v-model="checked[0]"
                :error="regExpChecks['recommenderParticipation']"
                type="checkbox"
                id="participation"
              >
                ...
                Лаб&#187;, с&nbsp;условиями
                <a href="/docs/rules.docx" target="_blank" download
                  >Программы</a
                >
                ознакомлен
              </BaseCheckbox>
              <BaseCheckbox
                v-model="checked[1]"
                :error="regExpChecks['recommenderProcessing']"
                type="checkbox"
                id="processing"
              >
              ...
              <BaseCheckbox
                v-model="checked[2]"
                :error="regExpChecks['recommenderSigning']"
                type="checkbox"
                id="signing"
              >
        ...
        <transition name="form-fade">
          <form
            v-if="candidate"
            @submit.stop.prevent="sendData()"
            class="form_candidate"
          >
            <div class="form secondForm">
              ...
              <BaseInput
                ...
                type="text"
                :error="regExpChecks['candidateName']"
                label="text"
                text="Имя и&nbsp;фамилия"
              >
              </BaseInput>
              <BaseInput
                ...
                type="email"
                :error="regExpChecks['candidateEmail']"
                label="email"
                text="Email"
              ></BaseInput>
              <BaseInput
                ...
                type="tel"
                :error="regExpChecks['candidatePhone']"
                label="tel"
                text="Номер телефона"
              ></BaseInput>
              <BaseCheckbox
                v-model="checked[3]"
                :error="regExpChecks['candidateParticipation']"
                type="checkbox"
              ...
              <BaseCheckbox
                v-model="checked[4]"
                :error="regExpChecks['candidateProcessing']"
                type="checkbox"
              ...
              >
                ...
                &#171;Промсвязьбанк&#187;. С&nbsp;&#171;<a
                  ...
                  >Согласием</a
                >
                на&nbsp;обработку персональных данных Кандидата Программы
                &#171;Приведи друга в&nbsp;ИТ&#187;&nbsp;ООО &#171;ПСБ Лаб&#187;
                ознакомлен
              </BaseCheckbox>
              <BaseCheckbox
                v-model="file"
                :error="regExpChecks['candidateFile']"
                id="candidateFile"
                type="file"
                class="file"
              ></BaseCheckbox>
            ...
            <div class="form-section_btn">
              <BaseButton class="custom-btn" v-if="!loader"
    ...
    <footer class="footer">
      ...
      <a
        ...
        >Согласие</a
      >
      на&nbsp;обработку персональных данных Рекомендателя,
      <a
        href="/docs/confirm_candidate.docx"
        class="link"
        target="_blank"
...
.secondForm {
  @media screen and (min-width: 1024px) {
    padding: 25px 40px 60.5px 40px !important;
  }
}
